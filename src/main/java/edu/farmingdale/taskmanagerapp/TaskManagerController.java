...
public class TaskManagerController extends Application {
    ...
    private void loadTasksFromDb() {
        if (dbManager != null && currentUser != null) {
            tasks.clear();
            dbManager.loadTasks(currentUser.getUserID(), tasks);
            taskTable.refresh();
            Platform.runLater(this::refreshAgendaAppointments);
        } else {
    ...
    public void addNewTaskFromDialog(Task newTask) {
        ...
        if (currentUser != null) {
            ...
            System.out.println("[DEBUG] Saving new task for userID: " + newTask.getUserID());
        }
    ...
    public void addNewTaskFrom(Task task) {
        if (task != null) {
            if (currentUser != null) {
                ...
                System.out.println("[DEBUG] Saving new task for userID: " + task.getUserID());
            }
    ...
    public void addImportedTask(Task task) {
        if (task != null) {
            if (currentUser != null) {
                task.setUserID(currentUser.getUserID());
                System.out.println("[DEBUG] Saving imported task for userID: " + task.getUserID());
            }
            if (dbManager != null) {
                try {
                    dbManager.addTask(task);
