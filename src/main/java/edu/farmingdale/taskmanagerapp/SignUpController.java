...
public class SignUpController {
    ...
    public void createNewAccount (ActionEvent actionEvent){
        try {
            ...
            UserSession existingUser = mainController.getDbManager().getAccount(newUser.getUserName());


            if (existingUser == null) {
                mainController.getDbManager().registerUser(newUser);

                // Fetch the user from the database to get the correct userID
                UserSession registeredUser = mainController.getDbManager().getAccount(newUser.getUserName());
                if (registeredUser != null) {
                    newUser.setUserID(registeredUser.getUserID());
                }
